            ...
            <form onSubmit={handleProductSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="flex flex-col gap-2">
                  <input type="text" required value={productForm.image_url} onChange={e => setProductForm({...productForm, image_url: e.target.value})} className="w-full bg-surface-container border border-white/10 rounded-lg p-3 text-on-surface outline-none text-body-sm" placeholder="e.g. https://example.com/product.jpg or local path" />
